...
var RoutedComponentInputBinder = class _RoutedComponentInputBinder {
  ...
  subscribeToRouteData(outlet) {
    ...
    const dataSubscription = (0, import_rxjs.combineLatest)([this.options.queryParams ? activatedRoute.queryParams : (0, import_rxjs.of)({}), activatedRoute.params, activatedRoute.data]).pipe((0, import_operators.switchMap)(([queryParams, params, data], index) => {
...
function setupActivatedRouteInjectors() {
  return (0, import_operators2.tap)(({
    newlyCreatedRoutes,
    targetRouterState
  }) => {
...
//# sourceMappingURL=chunk-K6HVTYNQ.js.map
